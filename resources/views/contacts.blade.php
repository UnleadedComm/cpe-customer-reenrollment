...
@section('content')
    ...
    <div class="container enrollment contact-information">
        ...
        {!! Form::open(['url' => 'enroll/update/authorized/contact']) !!}
        @elseif(session('AuthorizedContacts'))
        {!! Form::open(['url' => 'enroll/validate/additional/contact']) !!}
        @else
        {!! Form::open(['url' => 'enroll/validate/authorized/contact']) !!}
        @endif
...
<div id="contact-form-wrap">
        ...
        @if(isset($selectedContact))
        <div class="row open-primary-contact-form">
            <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <!--Primary Contact-->
                <input type="hidden" name="ContactType" value="PRIM">
                <input type="hidden" name="Relationship" value="account_holder">
                <!--Primary Contact END-->
                ...
                {{--<div class="form-group">--}}
                    ...
                    {{--@if(isset($selectedContact))--}}
                    {{--{{ Form::select('Relationship', config('app.available_relationship'), $selectedContact->Relationship, array('class' => 'form-control', 'placeholder' => 'Select One')) }}--}}
                    {{--@else--}}
                    {{--{{ Form::select('Relationship', config('app.available_relationship'), old('Relationship'), array('class' => 'form-control', 'placeholder' => 'Select One')) }}--}}
                    {{--@endif--}}
                {{--</div>--}}
            </div>
